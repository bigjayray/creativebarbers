...
<div class="wrapper container">
    ...
    <main class="d-flex justify-content-center">
        ...
        <form method="POST" class="col-md-7" action="">
            ...
            <fieldset class="container mb-2">
                ...
                <div class="row">
                    ...
                    <div class="form-group pt-2 col-md-6">
                        ...
                        <input type="text" class="form-control rounded-0 border border-secondary" placeholder="Name" id="name" name="name" required>
                    </div>

                    <div class=" form-group pt-2 col-md-6">
                        <label for="eml">Email</label>
                        <input type="text" class="form-control rounded-0 border border-secondary" placeholder="Email" id="eml" name="email" required>
                    </div>
                ...
                <div class="form-group d-flex justify-content-end py-5 mb-5">
                    <button type="submit" class="btn btn-dark px-5 rounded-0" name="make_reservation">MAKE RESERVATION</button>
                </div>
            </fieldset>
        </form>
    </main>
